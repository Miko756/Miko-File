...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6476586251:AAHTq4Nv8S3dlYRRsi95Mh2Qp9iQTMj76i0")
...
FILE_AUTO_DELETE = int(os.getenv("FILE_AUTO_DELETE", "1440")) # auto delete in seconds
...
try:
    ADMINS=[7085541484]
    for x in (os.environ.get("ADMINS", "1290041629").split()):
        ADMINS.append(int(x))
except ValueError:
